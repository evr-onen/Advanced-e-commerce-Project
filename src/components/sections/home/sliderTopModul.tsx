    ...
    <Grid container color="black">
      <Grid item xs={12} sm={4} display="flex" justifyContent="center" alignItems="center">
        <Grid container m="auto" justifyContent="center" columnSpacing={2} py="1.5625rem">
          <Grid item>
            <FaShippingFast fontSize="2rem" color={theme.palette.text.primary} />
          </Grid>
          <Grid item>
            <Typography color={theme.palette.text.primary} variant="subtitle1" fontWeight="700" textTransform="uppercase">
      ...
      <Grid item xs={12} sm={4} display="flex" justifyContent="center" alignItems="center">
        <Grid container m="auto" justifyContent="center" columnSpacing={2} py="1.5625rem">
          <Grid item>
            <RiRefund2Line fontSize="2rem" color={theme.palette.text.primary} />
          </Grid>
          <Grid item>
            <Typography color={theme.palette.text.primary} variant="subtitle1" fontWeight="700" textTransform="uppercase">
              free shipping & return
      ...
      <Grid item xs={12} sm={4} display="flex" justifyContent="center" alignItems="center">
        <Grid container m="auto" justifyContent="center" columnSpacing={2} py="1.5625rem">
          <Grid item>
            <Ri24HoursLine fontSize="2rem" color={theme.palette.text.primary} />
          </Grid>
          <Grid item>
            <Typography color={theme.palette.text.primary} variant="subtitle1" fontWeight="700" textTransform="uppercase">
              free shipping & return
